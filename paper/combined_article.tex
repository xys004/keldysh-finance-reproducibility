...
all windows [Fig.~\ref{fig:affinity}] --- consistent with the Gaussian
...
\begin{figure*}[t]
  ...
  \caption{Measured affinity against the Gaussian value
  $2\avg{Q_T}/\Var(Q_T)$. Agreement is consistent with
  Eq.~\eqref{eq:identity} and does not establish a fluctuation theorem.}
  \label{fig:affinity}
\end{figure*}
...
\begin{figure*}[t]
  \includegraphics[width=0.92\textwidth]{../output/figuras/fig16_scaling_reassessment.pdf}
